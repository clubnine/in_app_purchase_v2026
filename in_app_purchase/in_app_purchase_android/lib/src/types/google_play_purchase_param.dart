...
class GooglePlayPurchaseParam extends PurchaseParam {
  ...
  /// the purchase with the profile that initiated it. If specified, consider
  /// also setting [applicationUserName], which maps to the obfuscated account
  /// ID. When both [obfuscatedProfileId] and [androidProfileId] are provided,
  /// [obfuscatedProfileId] takes precedence.
