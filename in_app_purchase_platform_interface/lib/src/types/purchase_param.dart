...
class PurchaseParam {
  ...
  /// Android-only opaque profile identifier used to associate the purchase
  /// with a specific profile under the same account.
  ///
  /// This is forwarded to Google Play as `obfuscatedProfileId`. It is ignored
