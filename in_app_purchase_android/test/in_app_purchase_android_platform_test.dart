...
void main() {
  ...
  group('make payment', () {
    ...
    test('buyNonConsumable passes legacy androidProfileId', () async {
    ...
    test(
      'buyNonConsumable prefers obfuscatedProfileId over androidProfileId',
      () async {
        const profileId = 'newProfileId';
        const legacyProfileId = 'legacyProfileId';
        const expectedBillingResult = BillingResultWrapper(
          responseCode: BillingResponse.ok,
          debugMessage: 'dummy message',
        );
        ...
        final bool launchResult = await iapAndroidPlatform.buyNonConsumable(
          purchaseParam: GooglePlayPurchaseParam(
            ...
            androidProfileId: legacyProfileId,
            obfuscatedProfileId: profileId,
          ),
        );
